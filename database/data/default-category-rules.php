 ...
 * a sample of the default category taxonomy.
 *
 * Ported from src/db/default-category-rules.ts — keep in sync.
 *
 * @return list<array{pattern: string, categorySlug: string, amountSign?: string, priority?: int}>
 */
return [
    // coffee
